...
"""
Thin wrapper for the original full-private LoRA baseline.

This keeps the original newSHAFT private LoRA training flow:
- the whole model remains encrypted
- standard LoRA is used instead of LoRA-XS
- LoRA target modules are aligned with the other ablation groups
"""
