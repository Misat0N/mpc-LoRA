...
RUN_TAG="${RUN_TAG:-loraxs_shared_left_$(date +%Y%m%d_%H%M%S)}"
...
echo "[loraxs-shared-left] output_dir=${OUT_DIR}"

python run_glue_private_loraxs_shared_left_train.py \
...
echo "[loraxs-shared-left] done: ${OUT_DIR}"
