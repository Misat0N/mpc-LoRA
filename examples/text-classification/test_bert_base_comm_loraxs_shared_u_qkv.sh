...
RUN_TAG="${RUN_TAG:-loraxs_shared_u_qkv_$(date +%Y%m%d_%H%M%S)}"
...
echo "[loraxs-shared-u-qkv] output_dir=${OUT_DIR}"

python run_glue_private_loraxs_shared_u_qkv_train.py \
...
echo "[loraxs-shared-u-qkv] done: ${OUT_DIR}"
