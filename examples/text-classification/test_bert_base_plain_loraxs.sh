...
RUN_TAG="${RUN_TAG:-plain_loraxs_$(date +%Y%m%d_%H%M%S)}"
...
echo "[plain-loraxs] output_dir=${OUT_DIR}"

python run_glue_plain_loraxs_train.py \
...
echo "[plain-loraxs] done: ${OUT_DIR}"
